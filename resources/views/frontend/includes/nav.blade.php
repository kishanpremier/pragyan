<!--<nav class="navbar navbar-default">
    <div class="container">
        <div class="navbar-header">
           ...
           {{--   @if(settings()->logo)
            <a href="{{ route('frontend.auth.login') }}" class="logo"><img height="48" width="226" class="navbar-brand" src="{{route('frontend.index')}}/img/site_logo/{{settings()->logo}}"></a>
            @else --}}
             {{ link_to_route('frontend.auth.login',app_name(), [], ['class' => 'navbar-brand']) }}
           {{--  @endif --}}
        </div>navbar-header
